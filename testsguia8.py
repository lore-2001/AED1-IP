...
class test_agregar_frase_al_final(unittest.TestCase):
    def test_random(self):
        ruta_archivo= os.path.join("archivos txt para test","agregar_frase_al_final")
        archivo = open(ruta_archivo,"w")
        archivo.write("hola\na todos\n")
        archivo.close()
        agregar_frase_al_final(ruta_archivo,"como andan")
        archivo = open(ruta_archivo,"r")
        lineas = archivo.readlines()
        archivo.close()
        esperado= ["hola\n","a todos\n","como andan"]
        os.remove(ruta_archivo)
        self.assertEqual(lineas,esperado)

class test_agregar_frase_al_principio(unittest.TestCase):
    def test_random(self):
        ruta_archivo= os.path.join("archivos txt para test","agregar_frase_al_final")
        archivo = open(ruta_archivo,"w")
        archivo.write("hola\na todos\n")
        archivo.close()
        agregar_frase_al_principio(ruta_archivo,"como andan")
        archivo = open(ruta_archivo,"r")
        lineas = archivo.readlines()
        archivo.close()
        esperado= ["como andan\n","hola\n","a todos\n"]
